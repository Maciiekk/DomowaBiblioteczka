...
namespace DomowaBiblioteczka.Migrations.MediaDb
{
    ...
    [Migration("20241123234514_Imrove-schema")]
    partial class Imroveschema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorMedia", b =>
                {
                    ...
                    b.ToTable("MediaAuthors", (string)null);
                });
            ...
            modelBuilder.Entity("DomowaBiblioteczka.Data.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthorMedia", b =>
                {
                    b.HasOne("DomowaBiblioteczka.Data.Models.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DomowaBiblioteczka.Data.Models.Media", b =>
                {
                    b.HasOne("DomowaBiblioteczka.Data.Models.Industry", "Industry")
                        .WithMany("Medias")
            ...
            modelBuilder.Entity("DomowaBiblioteczka.Data.Models.MediaType", b =>
                {
                    b.HasOne("DomowaBiblioteczka.Data.Models.Unit", "Unit")
                        .WithMany("MediaTypes")
